    ...
    public class FLVER2MaterialInfoBank
    {
            ...
            internal void ReadXML(XmlNode node)
            {
                ...
                foreach (XmlNode bln in bufferLayoutNodes)
                {
                    ...
                    foreach (XmlNode memberNode in bln.ChildNodes)
                    {
                        ...
                        bufferLayout.Add(new FLVER.LayoutMember(memberType, memberSemantic, memberIndex, (short)memberBufferIndex));
                    }
        ...
        public class MaterialDef
        {
            ...
            public void ReadXML(XmlNode node)
            {
                ...
                Shader = node.SelectSingleNode("shader")?.InnerText.ToLower();
